        ...
        when (entity.task.statusType) {
            StatusType.NEW -> {
                ...
                if (entity.task.visitPoint?.pointType?.name != null) {
                    ...
                    if (entity.task.isCurrent){
                        getStatus(entity.task.isCurrent, "current")
                    }else{
                        getStatus(entity.task.isCurrent, "new")
                    }
                ...
                if (entity.isEdit != null) {
                    if (entity.isEdit == true) {
                        ...
                        if (entity.task.isCurrent){
                            getStatus(entity.task.isCurrent, "current draft")
                        }else{
                            getStatus(entity.task.isCurrent, "draft")
                        }
            ...
            StatusType.SUCCESS -> {
                ...
                if (entity.task.visitPoint?.pointType?.name != null) {
                    ...
                    getStatus(entity.task.isCurrent, "successfully")
            ...
            StatusType.PARTIALLY -> {
                ...
                if (entity.task.visitPoint?.pointType?.name != null) {
                    ...
                    getStatus(entity.task.isCurrent, "partially successful")
            ...
            StatusType.FAIL -> {
                ...
                if (entity.task.visitPoint?.pointType?.name != null) {
                    ...
                    getStatus(entity.task.isCurrent, "problem")
...
//        }
    ...
    // TODO: 02.09.2022 Если бесит вы можете удалить фенкцию и всё её яйца
    // Всё это нужно толька для тестирования
    @RequiresApi(Build.VERSION_CODES.O)
    fun getStatus(boolean: Boolean, name: String){
        if (boolean){
            layUnloading.tooltipText = name
        }else{
            layUnloading.tooltipText = name
        }
    }
